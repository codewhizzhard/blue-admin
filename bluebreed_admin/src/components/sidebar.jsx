...
const Sidebar = () => {
  ...
  return (
    <div className={`h-full border bg-white flex flex-col space-y-4 items-center pt-8 border-[#EDEFF2]`}>
        ...
        <Link to={"/ords"}  className={`text-[14px] font-bold ${locate.pathname === "/ords" ? "bg-[#FF89011A] text-[#E6B566]" : "text-[#4A4A4A]"}   w-[254px] h-[44px] flex px-4 rounded-[6px] items-center`}><span>Order Management</span></Link  >
